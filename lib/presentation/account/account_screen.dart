...
class AccountScreen extends StatelessWidget {
                      ...
                      child: Column(
                        ...
                        children: [
                          EdtTextField(
                            ...
                            label: state.currentUser?.name ?? TTNFlixConstants.name,
                            validator: (value) {
                          ...
                          EdtTextField(
                            ...
                            label: state.currentUser?.username ?? TTNFlixConstants.username,
                            validator: (value) {
                          ...
                          EdtTextField(
                            ...
                            label: state.currentUser?.dob ?? TTNFlixConstants.dob,
                            onTap: () {
                              if(state.isUpdate != null && state.isUpdate == false){
                          ...
                          TtnFlixDropdown(
                            ...
                            hintText: state.currentUser?.gender ?? TTNFlixConstants.gender,
                          ...
                          Button(
                            onClick: () {
                              if(state.isUpdate != null &&
                                  state.isUpdate == true){
                                _emailEditingController.text = state.currentUser?.username ?? '';
                                _nameEditingController.text = state.currentUser?.name ?? '';
                                _dobEditingController.text = state.currentUser?.dob ?? '';
                                _genderEditingController.text = state.currentUser?.gender ?? '';
                                BlocProvider.of<ProfileCubit>(context).updateUser(state.currentUser!);
                              }else{
                                _validateForm(state.currentUser);
                               var snackbar =  SnackBar(content: Text(TTNFlixConstants.updated));
                                ScaffoldMessenger.of(context).showSnackBar(snackbar);
                              }
                            },
                            buttonText: (state.isUpdate != null &&
                                    state.isUpdate == true)
  ...
  void _validateForm(UserModel? currentUser) async {
    if (_formKey.currentState?.validate() == true) {
      SystemChannels.textInput.invokeMethod("TextInput.hide");
      UserModel user = UserModel(
          username: _emailEditingController.text.isNotEmpty ? _emailEditingController.text : currentUser?.username,
          name:  _nameEditingController.text.isNotEmpty ? _nameEditingController.text : currentUser?.name,
          password: currentUser?.password,
          dob: _dobEditingController.text.isNotEmpty ? _dobEditingController.text : currentUser?.dob,
          gender: _genderEditingController.text.isNotEmpty ? _genderEditingController.text : currentUser?.gender);
       cubit.saveUser(user);
    }
  }
